...
public class LoadingView extends ViewGroup {
    ...
    private void init() {
        container = (RelativeLayout) LayoutInflater.from(getContext())
                .inflate(R.layout.layout_include_error, null);
        ...
        loadingView = (LinearLayout) container.findViewById(R.id.loadingView);
